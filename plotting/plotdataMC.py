...
if not os.path.isdir(f"plot/{arg.phase}_{arg.ext}_{time}/"):
    os.makedirs(f"plot/{arg.phase}_{arg.ext}_{time}/")
...
for discr in var_set:
    ...
    if arg.log:
        ...
        hep.mpl_magic(ax=ax)
        fig.savefig(
            f"plot/{arg.phase}_{arg.ext}_{time}/unc_{discr}_inclusive{scale}_{name}.pdf"
        )
        fig.savefig(
            f"plot/{arg.phase}_{arg.ext}_{time}/unc_{discr}_inclusive{scale}_{name}.png"
        )
    else:
        fig.savefig(
            f"plot/{arg.phase}_{arg.ext}_{time}/unc_{discr}_inclusive{scale}_{name}.pdf"
